<!-- borro el inicio, y le digo que extienda de ese arhivo que acabamos de crear-->
@extends('template')
<!-- posteriormente trabajo con esta sesion -->
@section('content')
    ...
    <div class="px-4">
        ...
        <div class="grid gridd-cols-1 gap-4 mb-4">
